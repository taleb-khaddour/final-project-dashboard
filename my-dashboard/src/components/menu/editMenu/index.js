  ...
  const handleSubmit = async () => {
    try {
      ...
      let response = await axios.patch(
        `https://idecream-backend.onrender.com/api/subCategory/${allData._id}`,
        updatedData,
        {
          headers: {
    ...
    <div className="back-form">
      <div className="form-submit">
          ...
          <Box sx={{ minWidth: 120 }}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value="645d5aba09113ff70a5d2cdb">Hot Drink</MenuItem>
              </Select>
            </FormControl>
          </Box>
        </Box>
        ...
        <div className="button-block">
          <Button variant="contained" color="error" onClick={props.showEdit}>
            {' '}
            Cancel
          </Button>
